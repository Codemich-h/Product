<section class="bg-gray-50 py-2 antialiased dark:bg-gray-900 md:py-2">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div class="mb-4 flex items-end justify-between gap-4 md:mb-8">
                <a href="#" title=""
                    class="flex justify-items-end text-base font-medium text-primary-700 hover:underline dark:text-white text-blue-500">
                    See more categories
