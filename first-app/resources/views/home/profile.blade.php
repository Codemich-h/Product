...
@section('content')
    <div
        class="bg-white p-6 [box-shadow:0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full max-w-sm rounded-2xl overflow-hidden mx-auto mt-12">
        <div class="flex flex-col items-center">
            ...
            <div class="mt-4 text-center">
                <p class="text-lg text-slate-900 font-semibold">John Doe</p>
                <p class="text-sm text-slate-500 mt-1">Marketing Coordinator</p>
            </div>
        </div>

        <div class="mt-8 flex flex-wrap justify-center gap-8">
            <div
                class="bg-gray-100 hover:bg-gray-200 w-11 h-11 p-3 flex items-center justify-center rounded-full cursor-pointer">
